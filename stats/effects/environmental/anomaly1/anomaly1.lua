function init()
  ...
  self.isCandavasWebber = world.entitySpecies(entity.id()) == "candavaswebber"
  ...
  if not self.postpone then
    if not self.isCandavasWebber then
    ...
    world.sendEntityMessage(entity.id(), "queueRadioMessage", "candawarningtier1anomaly", 5.0)
  end
  end
